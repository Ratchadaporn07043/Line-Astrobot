...
"""
            ...
            if birth_info_from_question and birth_info_from_question.get('date'):
                focus_instruction = """
**⚠️ คำสั่งสำคัญ: พยายามตอบให้ครบทั้ง 4 ด้านตามข้อมูลที่มี:**
...
- **ถ้าข้อมูลด้านใดไม่มีใน Context:** ให้ระบุชัดเจนว่า "ไม่มีข้อมูลในส่วนนี้" ห้ามแต่งขึ้นเอง
...
**🚨 สรุปข้อกำหนดสำคัญสำหรับคำถามที่มีวันเดือนปีเกิด:**
- พยายามตอบให้ครบทั้ง 4 ด้าน (การงาน, การเงิน, ความรัก, สีมงคล) แต่ถ้าข้อมูลไม่พอ ให้ตอบเท่าที่มี
- ห้าม Hallucinate หรือแต่งข้อมูลเองเมื่อไม่พบใน Context
- ใช้ข้อมูลจากฐานข้อมูล (MongoDB) ในการตอบคำถาม
- ตอบเป็นข้อความต่อเนื่องแบบธรรมชาติ ไม่ใช้หัวข้อหรือหมวดหมู่
